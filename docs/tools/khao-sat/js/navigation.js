/* AI Learn — shared top navigation for classroom tools. */
(function () {
  'use strict';
  var items = [
  ...
  function boot() {
    ...
    nav.innerHTML = '<a class="science-nav-brand" href="../../index.html" aria-label="AI Learn">' +
      '<span>A</span><b>AI Learn</b></a>' +
